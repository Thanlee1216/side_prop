    ...
    <div id="da-slider" class="da-slider">
        ...
        <div class="container">
            ...
            <div class="da-slide">
                ...
                <div class="da-img">
                    <img src="resources/img/Slider01.png" alt="image01" width="320">
                </div>
            </div>
            <!-- End first slide -->
            <!-- Start second slide -->
            <div class="da-slide">
                ...
                <a href="#" class="da-link button">Read more</a>
                <div class="da-img">
                    <img src="resources/img/Slider02.png" width="320" alt="image02">
                </div>
            </div>
            <!-- End second slide -->
            <!-- Start third slide -->
            <div class="da-slide">
                ...
                <a href="#" class="da-link button">Read more</a>
                <div class="da-img">
                    <img src="resources/img/Slider03.png" width="320" alt="image03">
                </div>
            </div>
            <!-- Start third slide -->
    ...
    <div class="container">
        ...
        <div class="row-fluid">
            <div class="span4">
                <div class="centered service">
                    <div class="circle-border zoom-in">
                        <img class="img-circle" src="resources/img/Service1.png" alt="service 1">
                    </div>
                    <h3>Modern Design</h3>
            ...
            <div class="span4">
                <div class="centered service">
                    <div class="circle-border zoom-in">
                        <img class="img-circle" src="resources/img/Service2.png" alt="service 2" />
                    </div>
            ...
            <div class="span4">
                <div class="centered service">
                    <div class="circle-border zoom-in">
                        <img class="img-circle" src="resources/img/Service3.png" alt="service 3">
                    </div>
                    <h3>Clean Code</h3>
    ...
    <div class="container">
        ...
        <div id="single-project">
            <div id="slidingDiv" class="toggleDiv row-fluid single-project">
                <div class="span6">
                    <img src="resources/img/Portfolio01.png" alt="project 1" />
                </div>
                <div class="span6">
            ...
            <div id="slidingDiv1" class="toggleDiv row-fluid single-project">
                <div class="span6">
                    <img src="resources/img/Portfolio02.png" alt="project 2">
                </div>
                <div class="span6">
                    <div class="project-description">
                        <div class="project-title clearfix">
            ...
            <div id="slidingDiv2" class="toggleDiv row-fluid single-project">
                <div class="span6">
                    <img src="resources/img/Portfolio03.png" alt="project 3">
                </div>
                <div class="span6">
                    <div class="project-description">
                        <div class="project-title clearfix">
            ...
            <div id="slidingDiv3" class="toggleDiv row-fluid single-project">
                <div class="span6">
                    <img src="resources/img/Portfolio04.png" alt="project 4">
                </div>
                <div class="span6">
                    <div class="project-description">
                        <div class="project-title clearfix">
            ...
            <div id="slidingDiv4" class="toggleDiv row-fluid single-project">
                <div class="span6">
                    <img src="resources/img/Portfolio05.png" alt="project 5">
                </div>
                <div class="span6">
                    <div class="project-description">
                        <div class="project-title clearfix">
            ...
            <div id="slidingDiv5" class="toggleDiv row-fluid single-project">
                <div class="span6">
                    <img src="resources/img/Portfolio06.png" alt="project 6">
                </div>
                <div class="span6">
                    <div class="project-description">
                        <div class="project-title clearfix">
            ...
            <div id="slidingDiv6" class="toggleDiv row-fluid single-project">
                <div class="span6">
                    <img src="resources/img/Portfolio07.png" alt="project 7">
                </div>
                <div class="span6">
                    <div class="project-description">
                        <div class="project-title clearfix">
            ...
            <div id="slidingDiv7" class="toggleDiv row-fluid single-project">
                <div class="span6">
                    <img src="resources/img/Portfolio08.png" alt="project 8">
                </div>
                <div class="span6">
                    <div class="project-description">
                        <div class="project-title clearfix">
            ...
            <div id="slidingDiv8" class="toggleDiv row-fluid single-project">
                <div class="span6">
                    <img src="resources/img/Portfolio09.png" alt="project 9">
                </div>
                <div class="span6">
                    <div class="project-description">
                        <div class="project-title clearfix">
    ...
    <div class="container">
        ...
        <div class="row-fluid team">
            <div class="span4" id="first-person">
                <div class="thumbnail">
                    <img src="resources/img/Team1.png" alt="team 1">
                    <h3>John Doe</h3>
                    <ul class="social">
                        <li>
                            <a href="">
            ...
            <div class="span4" id="second-person">
                <div class="thumbnail">
                    <img src="resources/img/Team2.png" alt="team 1">
                    <h3>John Doe</h3>
                    <ul class="social">
                        <li>
                            <a href="">
            ...
            <div class="span4" id="third-person">
                <div class="thumbnail">
                    <img src="resources/img/Team3.png" alt="team 1">
                    <h3>John Doe</h3>
                    <ul class="social">
                        <li>
                            <a href="">
            ...
            <div class="row">
                <div class="span4">
                    <div class="testimonial">
                        ...
                        <div class="whopic">
                            <div class="arrow"></div>
                            <img src="resources/img/Client1.png" class="centered" alt="client 1">
                            <strong>John Doe
                                <small>Client</small>
                            </strong>
                        </div>
                ...
                <div class="span4">
                    <div class="testimonial">
                        ...
                        <div class="whopic">
                            <div class="arrow"></div>
                            <img src="resources/img/Client2.png" class="centered" alt="client 2">
                            <strong>John Doe
                                <small>Client</small>
                            </strong>
                        </div>
                ...
                <div class="span4">
                    <div class="testimonial">
                        ...
                        <div class="whopic">
                            <div class="arrow"></div>
                            <img src="resources/img/Client3.png" class="centered" alt="client 3">
                            <strong>John Doe
                                <small>Client</small>
                            </strong>
                        </div>
    ...
    <div class="container centered">
        <div class="sub-section">
            ...
            <ul class="row client-slider" id="clint-slider">
                <li>
                    <a href="">
                        <img src="resources/img/clients/ClientLogo01.png" alt="client logo 1">
                    </a>
                </li>
                <li>
                    <a href="">
                        <img src="resources/img/clients/ClientLogo02.png" alt="client logo 2">
                    </a>
                </li>
                <li>
                    <a href="">
                        <img src="resources/img/clients/ClientLogo03.png" alt="client logo 3">
                    </a>
                </li>
                <li>
                    <a href="">
                        <img src="resources/img/clients/ClientLogo04.png" alt="client logo 4">
                    </a>
                </li>
                <li>
                    <a href="">
                        <img src="resources/img/clients/ClientLogo05.png" alt="client logo 5">
                    </a>
                </li>
                <li>
                    <a href="">
                        <img src="resources/img/clients/ClientLogo02.png" alt="client logo 6">
                    </a>
                </li>
                <li>
                    <a href="">
                        <img src="resources/img/clients/ClientLogo04.png" alt="client logo 7">
                    </a>
                </li>
            </ul>
        </div>
