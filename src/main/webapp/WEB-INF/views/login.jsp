...
<%-- 로그인 영역 --%>
            <div class="SignForm SignIn__form" style="justify-content: center">
                ...
                <!-- Modal -->
                <div class="modal fade" id="findPasswordModal" tabindex="-1" role="dialog" aria-labelledby="findPasswordModal" style="display: none">
